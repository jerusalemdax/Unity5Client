...
_jstype.definition.get_useGUILayout = function() { return CS.Call(2, 2, 0, false, this); }
_jstype.definition.set_useGUILayout = function(v) { return CS.Call(3, 2, 0, false, this, v); }
...
_jstype.definition.get_enabled = function() { return CS.Call(2, 3, 0, false, this); }
_jstype.definition.set_enabled = function(v) { return CS.Call(3, 3, 0, false, this, v); }

_jstype.definition.get_isActiveAndEnabled = function() { return CS.Call(2, 3, 1, false, this); }
_jstype.definition.set_isActiveAndEnabled = function(v) { return CS.Call(3, 3, 1, false, this, v); }
...
_jstype.definition.get_transform = function() { return CS.Call(2, 4, 0, false, this); }
_jstype.definition.set_transform = function(v) { return CS.Call(3, 4, 0, false, this, v); }

_jstype.definition.get_gameObject = function() { return CS.Call(2, 4, 1, false, this); }
_jstype.definition.set_gameObject = function(v) { return CS.Call(3, 4, 1, false, this, v); }

_jstype.definition.get_tag = function() { return CS.Call(2, 4, 2, false, this); }
_jstype.definition.set_tag = function(v) { return CS.Call(3, 4, 2, false, this, v); }
...
_jstype.definition.GetComponentInChildren$1 = function(t0) {
    ...
    return CS.Call(4, 4, 11, false, this, native_t0);
}
/* Component */
...
_jstype.definition.GetComponentsInParent$1$$Boolean$$List$1 = function(t0, a0/*Boolean*/, a1/*List`1*/) {
    ...
    return CS.Call(4, 4, 25, false, this, native_t0, a0, a1);
}
/* T[] */
_jstype.definition.GetComponentsInParent$1$$Boolean = function(t0, a0/*Boolean*/) {
        var native_t0 = t0.getNativeType();

    return CS.Call(4, 4, 26, false, this, native_t0, a0);
}
/* Component[] */
...
_jstype.definition.get_name = function() { return CS.Call(2, 5, 0, false, this); }
_jstype.definition.set_name = function(v) { return CS.Call(3, 5, 0, false, this, v); }

_jstype.definition.get_hideFlags = function() { return CS.Call(2, 5, 1, false, this); }
_jstype.definition.set_hideFlags = function(v) { return CS.Call(3, 5, 1, false, this, v); }
...
_jstype.definition.Equals = function(a0/*Object*/) {
    ...
    return CS.Call(4, 5, 0, false, this, a0);
}
/* Int32 */
_jstype.definition.GetHashCode = function() {
    
    return CS.Call(4, 5, 1, false, this);
}
/* Int32 */
_jstype.definition.GetInstanceID = function() {
    
    return CS.Call(4, 5, 2, false, this);
}
/* String */
_jstype.definition.toString = function() {
    
    return CS.Call(4, 5, 3, false, this);
}
/* static Void  */
...
_jstype.staticDefinition.get_logger = function() { return CS.Call(2, 6, 0, true); }
_jstype.staticDefinition.set_logger = function(v) { return CS.Call(3, 6, 0, true, v); }

_jstype.staticDefinition.get_developerConsoleVisible = function() { return CS.Call(2, 6, 1, true); }
_jstype.staticDefinition.set_developerConsoleVisible = function(v) { return CS.Call(3, 6, 1, true, v); }

_jstype.staticDefinition.get_isDebugBuild = function() { return CS.Call(2, 6, 2, true); }
_jstype.staticDefinition.set_isDebugBuild = function(v) { return CS.Call(3, 6, 2, true, v); }
