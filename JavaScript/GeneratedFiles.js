...
/* Void */
_jstype.definition.Request = function(a0/*String*/, a1/*JsonObject*/, a2/*Action`1*/) {
    
    return CS.Call(4, 0, 1, false, this, a0, a1, a2);
}
/* Void */
_jstype.definition.Update = function() {
    
    return CS.Call(4, 0, 2, false, this);
}
...
/* String */
_jstype.definition.GetShowedSceneName = function() {
...
_jstype.definition.ClosePanel = function(a0/*String*/) {
    ...
    return CS.Call(4, 2, 0, false, this, a0);
}
/* Void */
_jstype.definition.Init = function() {
...
_jstype.definition.ShowPanel = function(a0/*String*/) {
    ...
    return CS.Call(4, 2, 2, false, this, a0);
}
...
_jstype.definition.ctor = function() { CS.Call(5, 3, 0, true, this); }

// fields

// properties

_jstype.staticDefinition.get_Instance = function() { return CS.Call(2, 3, 0, true); }
_jstype.staticDefinition.set_Instance = function(v) { return CS.Call(3, 3, 0, true, v); }
...
_jstype.definition.get_useGUILayout = function() { return CS.Call(2, 4, 0, false, this); }
_jstype.definition.set_useGUILayout = function(v) { return CS.Call(3, 4, 0, false, this, v); }
...
_jstype.definition.CancelInvoke = function() {
    ...
    return CS.Call(4, 4, 1, false, this);
}
/* Void */
...
_jstype.definition.InvokeRepeating = function(a0/*String*/, a1/*Single*/, a2/*Single*/) {
    ...
    return CS.Call(4, 4, 3, false, this, a0, a1, a2);
}
/* Boolean */
...
_jstype.definition.get_enabled = function() { return CS.Call(2, 5, 0, false, this); }
_jstype.definition.set_enabled = function(v) { return CS.Call(3, 5, 0, false, this, v); }

_jstype.definition.get_isActiveAndEnabled = function() { return CS.Call(2, 5, 1, false, this); }
_jstype.definition.set_isActiveAndEnabled = function(v) { return CS.Call(3, 5, 1, false, this, v); }
...
_jstype.definition.get_transform = function() { return CS.Call(2, 6, 0, false, this); }
_jstype.definition.set_transform = function(v) { return CS.Call(3, 6, 0, false, this, v); }

_jstype.definition.get_gameObject = function() { return CS.Call(2, 6, 1, false, this); }
_jstype.definition.set_gameObject = function(v) { return CS.Call(3, 6, 1, false, this, v); }

_jstype.definition.get_tag = function() { return CS.Call(2, 6, 2, false, this); }
_jstype.definition.set_tag = function(v) { return CS.Call(3, 6, 2, false, this, v); }
...
_jstype.definition.BroadcastMessage$$String$$Object$$SendMessageOptions = function(a0/*String*/, a1/*Object*/, a2/*SendMessageOptions*/) {
    ...
    return CS.Call(4, 6, 0, false, this, a0, a1, a2);
}
/* Void */
...
_jstype.definition.BroadcastMessage$$String$$SendMessageOptions = function(a0/*String*/, a1/*SendMessageOptions*/) {
    ...
    return CS.Call(4, 6, 2, false, this, a0, a1);
}
/* Void */
_jstype.definition.BroadcastMessage$$String = function(a0/*String*/) {
    
    return CS.Call(4, 6, 3, false, this, a0);
}
/* Boolean */
...
_jstype.definition.GetComponent$$Type = function(a0/*Type*/) {
    ...
    return CS.Call(4, 6, 5, false, this, a0);
}
/* Component */
...
_jstype.definition.GetComponentInParent$1 = function(t0) {
    ...
    return CS.Call(4, 6, 13, false, this, native_t0);
}
/* Void */
...
_jstype.definition.GetComponents$1$$List$1 = function(t0, a0/*List`1*/) {
    ...
    return CS.Call(4, 6, 15, false, this, native_t0, a0);
}
/* Component[] */
_jstype.definition.GetComponents$$Type = function(a0/*Type*/) {
    
    return CS.Call(4, 6, 16, false, this, a0);
}
/* T[] */
_jstype.definition.GetComponents$1 = function(t0) {
        var native_t0 = t0.getNativeType();

    return CS.Call(4, 6, 17, false, this, native_t0);
}
/* Component[] */
...
_jstype.definition.GetComponentsInChildren$1$$Boolean$$List$1 = function(t0, a0/*Boolean*/, a1/*List`1*/) {
    ...
    return CS.Call(4, 6, 19, false, this, native_t0, a0, a1);
}
/* Component[] */
...
_jstype.definition.get_name = function() { return CS.Call(2, 7, 0, false, this); }
_jstype.definition.set_name = function(v) { return CS.Call(3, 7, 0, false, this, v); }

_jstype.definition.get_hideFlags = function() { return CS.Call(2, 7, 1, false, this); }
_jstype.definition.set_hideFlags = function(v) { return CS.Call(3, 7, 1, false, this, v); }
...
_jstype.definition.Equals = function(a0/*Object*/) {
    ...
    return CS.Call(4, 7, 0, false, this, a0);
}
/* Int32 */
_jstype.definition.GetHashCode = function() {
    
    return CS.Call(4, 7, 1, false, this);
}
/* Int32 */
_jstype.definition.GetInstanceID = function() {
    
    return CS.Call(4, 7, 2, false, this);
}
/* String */
_jstype.definition.toString = function() {
    
    return CS.Call(4, 7, 3, false, this);
}
/* static Void  */
...
_jstype.staticDefinition.get_logger = function() { return CS.Call(2, 8, 0, true); }
_jstype.staticDefinition.set_logger = function(v) { return CS.Call(3, 8, 0, true, v); }

_jstype.staticDefinition.get_developerConsoleVisible = function() { return CS.Call(2, 8, 1, true); }
_jstype.staticDefinition.set_developerConsoleVisible = function(v) { return CS.Call(3, 8, 1, true, v); }

_jstype.staticDefinition.get_isDebugBuild = function() { return CS.Call(2, 8, 2, true); }
_jstype.staticDefinition.set_isDebugBuild = function(v) { return CS.Call(3, 8, 2, true, v); }
